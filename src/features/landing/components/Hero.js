...
<button className="hover:cursor-pointer bg-primary text-on-primary px-10 py-4 rounded-xl font-button text-button shadow-lg shadow-primary/20 hover:translate-y-[-2px] transition-all">Explore Properties</button>
